...
trait ElementWrapTrait {
   ...
   *   `2xl`, and `3xl`. Those sizes refer to the size on desktop. While Tailwind
   *   works as  mobile first, when we implement the design that in reality we
   *   start from the desktop, and work our way down to the mobile. Furthermore,
   *   on mobile the font size  may remain bigger, and won't become smaller - to
